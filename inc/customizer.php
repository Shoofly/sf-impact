 ...
 class sf_impact_Customize {
    private $customStylesObj;
     function __construct()
     {
        ...
        add_action( 'wp_enqueue_scripts' , array( $this, 'sf_impact_header_output' ) );
    ...
    public function  sf_impact_customize_register( $wp_customize ) {
       ...
       $wp_customize->add_panel( 'sf_impact_panel_home', array(
          ...
          $wp_customize->add_setting( 'sf_impact_logo_minwidth', 
                array(
                'default' => $sf_impact_Theme_Mods->getDefault('sf_impact_logo_minwidth'),
                'type' => 'theme_mod', 
                'capability' => 'edit_theme_options', 
                'transport' => 'refresh', 
            ...
            $wp_customize->add_control( new WP_Customize_Control (
                ...
                $wp_customize, 
                'sf_impact_logo_minwidth', 
                array(
                'label' => __( 'Mimimum width of logo when menu and logo are above the header', 'sf-impact' ), 
                  'section' => 'title_tagline',  
                'settings' => 'sf_impact_logo_minwidth', 
                'priority' => 15, 
 ...
 //'style'="font-style:italic"
    ...
    $wp_customize->add_setting( 'sf_impact_slider_count', 
       ...
       $wp_customize->add_control( new Number_Custom_Control (
            ...
            array(
            'label' => __( 'Number of Slides', 'sf-impact' ), 
                'description' => __('Maximum number of slides to show', 'sf-impact' ), 
...
//            <style type="text/css">
               // <?php 
                ...
                $sf_impact_logo_minwidth       =  $sf_impact_Theme_Mods->getMod( 'sf_impact_logo_minwidth');
                $outu = " /*--Customizer CSS--*/";
                if ($sf_impact_logo_minwidth != '')
                    $outu .= "
                    .site-branding  img { min-width:$sf_impact_logo_minwidth;}
                    ";
          ...
          //      $outu .= sprintf( "%s {%s:%s;}", ".flexslider", "min-height", $sf_impact_Theme_Mods->getMod('sf_impact_header_height') );
                ...
                $outu = apply_filters('sf_impact_customizer_styles', $outu);
                $outu .= "/* End Customizer CSS */";
                wp_add_inline_style( 'sf_impact_theme_styles', $outu);  //Insert Styles
